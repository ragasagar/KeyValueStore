...
private:
    ...
    public:
        ...
        void Proceed() {
            if (status_ == CREATE) {
                ...
                asyncService->RequestGetValues(&serverContext, &request, &responseEntity, completionQueue, completionQueue,
                                               this);
                ...
                // the event.
                status_ = FINISH;
                responseEntity.Finish(response, Status::OK, this);
            } else {
    ...
    private:
        ...
        ServerAsyncResponseWriter<Response> responseEntity;
